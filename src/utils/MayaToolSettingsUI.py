...
class Ui_ToolSettings(object):
    def setupUi(self, ToolSettings):
        ...
        self.actionAbout = QAction(ToolSettings)
        ...
        self.pb_cancle = QPushButton(self.centralwidget)
        self.pb_cancle.setObjectName(u"pb_cancle")
        sizePolicy.setHeightForWidth(self.pb_cancle.sizePolicy().hasHeightForWidth())
        self.pb_cancle.setSizePolicy(sizePolicy)
        self.pb_cancle.setMaximumSize(QSize(100, 25))

        self.horizontalLayout.addWidget(self.pb_cancle)
    ...
    def retranslateUi(self, ToolSettings):
        ToolSettings.setWindowTitle("Settings")
        self.actionReset_Settings.setText("Reset Settings")
        self.actionHelp_on_this_tool.setText("Help on this tool")
        self.actionAbout.setText("About")
        self.actionSave_Settings.setText("Save Settings")
        self.actionf.setText("f")
        self.pb_apply.setText("Apply")
        self.pb_save.setText("Save and Close")
        self.pb_cancle.setText("Cancle")
